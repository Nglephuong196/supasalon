...
export function SignUpPage() {
  ...
  function validatePhone(value: string): boolean {
    if (!value) return setFieldError("ownerPhone", "Vui lòng nhập số điện thoại");
    if (!VIETNAM_PHONE_REGEX.test(value)) {
      return setFieldError("ownerPhone", "Số điện thoại không hợp lệ (VD: 0901234567)");
    }
    return setFieldError("ownerPhone", null);
  }
  ...
  return (
    <div className="relative flex min-h-[70vh] items-center justify-center overflow-hidden px-2 py-8 sm:px-4">
      <div className="pointer-events-none absolute top-[-10%] right-[-5%] h-[500px] w-[500px] rounded-full bg-purple-100/40 blur-3xl" />
      <div className="pointer-events-none absolute bottom-[-10%] left-[-5%] h-[500px] w-[500px] rounded-full bg-indigo-100/40 blur-3xl" />

      <Card className="relative z-10 w-full max-w-lg bg-card/95">
        <CardHeader className="space-y-1 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-linear-to-r from-purple-600 to-indigo-600 text-white">
