...
<div
    class="group relative rounded-xl bg-card transition-all hover:shadow-md overflow-hidden {item.type ===
    'service'
...
>
    <!-- Header -->
    <div
        class="px-4 py-3 flex items-center justify-between gap-3 {item.type ===
        'service'
            ? 'bg-primary/5'
    ...
    <div class="p-4">
        <div class="grid grid-cols-12 gap-3 items-end">
            ...
            <div class="col-span-4">
                <Label
                    class="text-[10px] mb-1.5 block text-muted-foreground uppercase tracking-wide"
                >
                    Đơn giá
                </Label>
                <div class="relative">
                    ...
                    />
                    <span
                        class="absolute right-2.5 top-2.5 text-xs text-muted-foreground"
                        >đ</span
                    >
                </div>
            </div>
