...
import { Crown, Mail, Phone } from "lucide-react-native";
...
const avatarGradients = ["#9333ea", "#ec4899", "#3b82f6", "#22c55e", "#f97316"];
...
export default function CustomersScreen() {
  ...
  const handleDelete = (id: number) => {
    Alert.alert("Xác nhận xóa", "Bạn có chắc chắn muốn xóa khách hàng này?", [
