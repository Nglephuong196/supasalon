...
export const customers = sqliteTable("customers", {
    ...
    membershipTierId: integer("membership_tier_id").references(
        () => membershipTiers.id,
    ),
    createdAt: integer("created_at", { mode: "timestamp" })
        .notNull()
...
export const invoices = sqliteTable("invoices", {
    ...
    discountType: text("discount_type", { enum: ["percent", "fixed"] }).default(
        "percent",
    ),
...
export const staffCommissionRules = sqliteTable(
    ...
    (table) => ({
        staffItemUnique: uniqueIndex(
            "staff_commission_rules_staff_item_unique",
        ).on(table.organizationId, table.staffId, table.itemType, table.itemId),
    }),
);
...
export const customerMembershipsRelations = relations(
    customerMemberships,
    ({ one }) => ({
...
export const invoiceItemStaffRelations = relations(
    invoiceItemStaff,
    ({ one }) => ({
...
export const staffCommissionRulesRelations = relations(
...
export const memberPermissionsRelations = relations(
    memberPermissions,
    ({ one }) => ({
        member: one(member, {
