...
export type CustomerInsert = Omit<Customer, "id" | "created_at" | "updated_at" | "deleted_at" | "salon_id">
...
export type ServiceCategoryInsert = Omit<ServiceCategory, "id" | "created_at" | "updated_at" | "salon_id">
